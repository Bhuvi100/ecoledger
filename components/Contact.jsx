...
const Contact = () => {
  return (
    <div>
      <section class="relative z-10 overflow-hidden bg-white px-28 lg:py-[120px]">
          ...
          <div class="-mx-4 flex flex-wrap lg:justify-between">
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div class="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p class="text-body-color mb-9 text-base leading-relaxed"></p>
              ...
              <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      class="bg-green-500 border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
